...
const PAGES = [
  { img: '/images/reader/what-a-doodle-do/page-04.jpg', text: `beanstalk-a-doodle-do!`, pn: 4 },
  { img: '/images/reader/what-a-doodle-do/page-05.jpg', text: `sleepwalk-a-doodle-do!`, pn: 5 },
  { img: '/images/reader/what-a-doodle-do/page-06.jpg', text: `chalk-a-doodle-do!`, pn: 6 },
  { img: '/images/reader/what-a-doodle-do/page-08.jpg', text: `bedrock-a-doodle-do!`, pn: 8 },
  { img: '/images/reader/what-a-doodle-do/page-11.jpg', text: `lock-a-doodle-do!`, pn: 11 },
  { img: '/images/reader/what-a-doodle-do/page-12.jpg', text: `talk-a-doodle-do!`, pn: 12 },
  { img: '/images/reader/what-a-doodle-do/page-13.jpg', text: `bach-a-doodle-do!`, pn: 13 },
  { img: '/images/reader/what-a-doodle-do/page-14.jpg', text: `wok-a-doodle-do!`, pn: 14 },
  { img: '/images/reader/what-a-doodle-do/page-16.jpg', text: `sherlock-a-doodle-do!`, pn: 16 },
  { img: '/images/reader/what-a-doodle-do/page-17.jpg', text: `block-a-doodle-do!`, pn: 17 },
  { img: '/images/reader/what-a-doodle-do/page-22.jpg', text: `boardwalk-a-doodle-do!`, pn: 22 },
  { img: '/images/reader/what-a-doodle-do/page-23.jpg', text: `shamrock-a-doodle-do!`, pn: 23 },
  { img: '/images/reader/what-a-doodle-do/page-24.jpg', text: `walk-a-doodle-do!`, pn: 24 },
  { img: '/images/reader/what-a-doodle-do/page-25.jpg', text: `croc-a-doodle-do!`, pn: 25 },
  { img: '/images/reader/what-a-doodle-do/page-26.jpg', text: `jock-a-doodle-do!`, pn: 26 },
  { img: '/images/reader/what-a-doodle-do/page-27.jpg', text: `doc-a-doodle-do!`, pn: 27 },
  { img: '/images/reader/what-a-doodle-do/page-28.jpg', text: `clock-a-doodle-do!`, pn: 28 },
  { img: '/images/reader/what-a-doodle-do/page-30.jpg', text: `sock-a-doodle-do!`, pn: 30 },
  { img: '/images/reader/what-a-doodle-do/page-32.jpg', text: `catwalk-a-doodle-do!`, pn: 32 },
  { img: '/images/reader/what-a-doodle-do/page-33.jpg', text: `mohawk-a-doodle-do!`, pn: 33 },
  { img: '/images/reader/what-a-doodle-do/page-34.jpg', text: `COCK-A-DOODLE-DO!!!`, pn: 34 },
];
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            color: pageIdx === 0borderRadius: 40,
            width: 44, height: 44,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <button
          ...
          style={{
            ...
            width: 44, height: 44,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            color: pageIdx === total - 1borderRadius: 40,
            width: 44, height: 44,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
