...
const PAGES = [
  ...
  { img: '/images/reader/brian-the-ghost/spreads/spread-003.jpg', text: `At night, in the quiet town of St. Germaine… MONSTERS roam the streets.`, audioUrl: '/audio/reader/brian-the-ghost/spread-003.mp3', pn: 3 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-004.jpg', text: `There was Cleo, a MATERIALISTIC MUMMY. And there was Roman, a WISTFUL WEREWOLF.`, audioUrl: '/audio/reader/brian-the-ghost/spread-004.mp3', pn: 4 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-005.jpg', text: `There was Sir Gregor, a GHOULISH… well… GHOUL. …and then there was Brian.`, audioUrl: '/audio/reader/brian-the-ghost/spread-005.mp3', pn: 5 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-006.jpg', text: `Brian was a perfectly normal, everyday, regular GHOST. Yet, Brian was different in one VERY BIG way.`, audioUrl: '/audio/reader/brian-the-ghost/spread-006.mp3', pn: 6 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-007.jpg', text: `While all the other monsters of St. Germaine loved to SPOOK! And BOO! And SCARE! Brian did not. Brian just wanted to read BOOKS and play GAMES and watch MOVIES.`, audioUrl: '/audio/reader/brian-the-ghost/spread-007.mp3', pn: 7 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-008.jpg', text: `But, more than anything, Brian wanted a friend. "You want to be friends? With one of them?" laughed the others. "Monsters don't make friends.`, audioUrl: '/audio/reader/brian-the-ghost/spread-008.mp3', pn: 8 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-009.jpg', text: `"We HAUNT them. We HOWL at them. We HISS at them. We never make friends." But Brian wasn't listening… Something the ghosts said gave him an idea. What if he haunted nicely? Then someone would surely be his friend.`, audioUrl: '/audio/reader/brian-the-ghost/spread-009.mp3', pn: 9 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-010.jpg', text: `So, he made plans to begin the next night.`, audioUrl: '/audio/reader/brian-the-ghost/spread-010.mp3', pn: 10 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-011.jpg', text: `The first night, Brian went to the Bleecker house. "Children love clowns," he thought. "And surprises!" So, he turned into a clown and hid in the toy box.`, audioUrl: '/audio/reader/brian-the-ghost/spread-011.mp3', pn: 11 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-012.jpg', text: `It did not go like he thought.`, audioUrl: '/audio/reader/brian-the-ghost/spread-012.mp3', pn: 12 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-013.jpg', text: `The second night, he went to the Peterson house where he spied children washing their faces before bed. "Maybe I can be helpful?" thought Brian.`, audioUrl: '/audio/reader/brian-the-ghost/spread-013.mp3', pn: 13 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-014.jpg', text: `It did not go like he thought.`, audioUrl: '/audio/reader/brian-the-ghost/spread-014.mp3', pn: 14 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-015.jpg', text: `The third night, Brian had an even better idea. He went to the Smith's, where the family was gathered in front of the television. "I just know this will work," he reassured himself.`, audioUrl: '/audio/reader/brian-the-ghost/spread-015.mp3', pn: 15 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-016.jpg', text: `It did not go like he thought.`, audioUrl: '/audio/reader/brian-the-ghost/spread-016.mp3', pn: 16 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-017.jpg', text: `After three long nights, Brian was out of ideas. So, he went back to the place where he read his books and played his games and watched his movies… and he began to cry. "I just wish I had someone to play with…"`, audioUrl: '/audio/reader/brian-the-ghost/spread-017.mp3', pn: 17 },
  { img: '/images/reader/brian-the-ghost/spreads/spread-018.jpg', text: `"I like your stuff!" A little girl named Lucy springs up from behind a pile of books. Brian screams in terror.`, audioUrl: '/audio/reader/brian-the-ghost/spread-018.mp3', pn: 18 },
  ...
  { img: '/images/reader/brian-the-ghost/spreads/spread-020.jpg', text: `And so, the two friends played and laughed late into the night in the quiet — well, maybe not so quiet — town of St. Germaine.`, audioUrl: '/audio/reader/brian-the-ghost/spread-020.mp3', pn: 20 },
  ...
  { img: '/images/reader/brian-the-ghost/spreads/spread-023.jpg', text: null, audioUrl: null, pn: 23 },
];
      ...
      {[...Array(8)].map((_, i) => (
        <div
          ...
          style={{
            ...
            height: 6 + (i % 3) * 4,
            borderRadius: '50%',
            background: i % 2 === 0 ? ACCENT : '#B0E0FF',
            opacity: 0,
            top: `${10 + i * 10}%`,
            left: `${5 + i * 12}%`,
  ...
  if (!started) {
    return (
      <div
        style={{
          minHeight: '100dvh',
          background: 'linear-gradient(160deg, #10081e 0%, #22105a 45%, #3a1870 100%)',
          display: 'flex',
      ...
      >
        ...
        <button
          ...
          style={{
            background: 'linear-gradient(135deg, #9B8AD0, #4a1a80)',
            color: 'white',
            ...
            fontWeight: 700,
            cursor: 'pointer',
            boxShadow: '0 6px 24px rgba(123,94,167,0.45)',
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        justifyContent: 'space-between',
        padding: '10px 16px',
        background: 'rgba(12,6,25,0.88)',
        borderTop: '1px solid rgba(123,94,167,0.20)',
        gap: 12,
        flexShrink: 0,
      }}>
        <button
          ...
          style={{
            background: pageIdx === 0 ? 'rgba(255,255,255,0.05)' : 'rgba(123,94,167,0.25)',
            ...
            {PAGES.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: 8,
                  borderRadius: 4,
                  background: i === pageIdx ? ACCENT : i < pageIdx ? 'rgba(123,94,167,0.55)' : 'rgba(255,255,255,0.12)',
                  border: 'none',
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                  padding: 0,
        ...
        <button
          ...
          style={{
            background: pageIdx === total - 1 ? 'rgba(255,255,255,0.05)' : 'rgba(123,94,167,0.25)',
            border: '1px solid rgba(123,94,167,0.45)',
            borderRadius: 40,
            width: 44, height: 44,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
