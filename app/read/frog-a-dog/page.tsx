  ...
  if (!started) {
    return (
      <div
        style={{
          minHeight: '100dvh',
          background: 'linear-gradient(160deg, #0a1408 0%, #1a3a18 45%, #2a5a28 100%)',
          display: 'flex',
      ...
      >
        ...
        <button
          ...
          style={{
            background: 'linear-gradient(135deg, #5DB840, #1a3a18)',
            color: 'white',
            ...
            fontWeight: 700,
            cursor: 'pointer',
            boxShadow: '0 6px 24px rgba(74,155,53,0.45)',
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        borderTop: '1px solid rgba(74,155,53,0.18)',
        gap: 12,
        flexShrink: 0,
      }}>
        <button
          ...
          style={{
            background: pageIdx === 0 ? 'rgba(255,255,255,0.05)' : 'rgba(74,155,53,0.22)',
            border: '1px solid rgba(74,155,53,0.45)',
            borderRadius: 40,
            width: 44, height: 44,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 6 }}>
            ...
            {PAGES.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: 8,
                  borderRadius: 4,
                  background: i === pageIdx ? ACCENT : i < pageIdx ? 'rgba(74,155,53,0.55)' : 'rgba(255,255,255,0.12)',
                  border: 'none',
                  cursor: 'pointer',
                  transition: 'all 0.2s',
                  padding: 0,
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
            <button
              ...
              style={{
                background: 'rgba(74,155,53,0.18)',
                border: '1px solid rgba(74,155,53,0.45)',
                borderRadius: 20,
                padding: '4px 14px',
        ...
        <button
          ...
          style={{
            background: pageIdx === total - 1 ? 'rgba(255,255,255,0.05)' : 'rgba(74,155,53,0.22)',
            border: '1px solid rgba(74,155,53,0.45)',
            borderRadius: 40,
            width: 44, height: 44,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
