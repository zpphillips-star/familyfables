...
const STORIES = [
  {
    ...
    pages: 21,
    voiceNote: 'Read aloud + page images',
  },
  {
  ...
  },
  {
    ...
    tagline: 'The friendliest ghost in St. Germaine 👻',
    cover: '/images/books/brian-the-ghost.jpg',
    color: '#3a1a6e',
    accent: '#8b5fc0',
    badge: '🎃 Halloween',
    pages: 19,
    voiceNote: 'Read aloud story',
  },
  {
    slug: 'dream-ideas',
    title: 'Dream Ideas',
    tagline: 'A bedtime singalong full of imagination 🌙',
    cover: '/images/books/dream-ideas.png',
    color: '#0a1860',
    accent: '#4a8fd0',
    badge: '🎵 Singalong',
    pages: 14,
    voiceNote: 'Sing along at bedtime',
  },
  {
    slug: 'finding-hampton',
    title: 'Finding Hampton',
    tagline: "The best birthday gift was never a thing 🎈",
  ...
  },
  {
    ...
    tagline: 'Find your own voice this Thanksgiving 🦃',
  ...
  },
  {
    ...
    tagline: 'One indoor cat, one big adventure 🐱',
  ...
  },
  {
    ...
    tagline: 'Thanksgiving fun sung to Wheels on the Bus 🦃',
    cover: '/images/books/one-tom-turkey.png',
    color: '#7a3a10',
    accent: '#c87030',
    badge: '🎵 Singalong',
    pages: 11,
    voiceNote: 'Sing along — Wheels on the Bus tune!',
  },
];
