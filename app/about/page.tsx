    ...
    <div>
      ...
      >
        <div className="max-w-3xl mx-auto w-full">
          ...
          >
            Ours started with a boy from Brooklyn, a lifetime of unshared poems,
            and one very determined grandson who decided the world had waited long enough.
          </p>
        </div>
      </section>
      ...
      >
        <div className="max-w-xl mx-auto">
          ...
          >
            The books are waiting. The adventures are ready.
          </h2>
          <p className="text-base mb-8" style={{ color: "#7B6898" }}>
            Victor spent a lifetime with stories in his heart. Now they&apos;re on
            every page — pick one up and start reading tonight.
          </p>
