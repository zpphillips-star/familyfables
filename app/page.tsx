...
const landDefs: LandDef[] = [
  // 1. Dragon Mountain
  {
    ...
    tagline: "A regular girl steps through a closet into a magical land — and discovers she's the Dragon Keeper",
  ...
  // 2. Poo Poo Face Town
  {
    ...
    tagline: "A boy and his dad investigate the one expression that unites all living things — yes, even dragons",
  ...
  // 4. Hampton's Quest Meadow
  {
    ...
    tagline: "Hampton needs the perfect birthday gift for a rhino who has everything — it's been with him all along",
  ...
  // 5. Gilroy's Harvest Forest
  {
    ...
    tagline: "Every turkey in the barnyard goes 'gobble.' Gilroy had other ideas about what his voice should sound like.",
  ...
  // 6. Dream Land
  {
    ...
    emoji: "🌙",
    landName: "Dream Land",
    tagline: "A bedtime singalong set to an original tune — so warm and catchy that getting kids to sleep becomes fun",
  ...
  // 7. Lumpiest Pumpkin Patch
  {
    ...
    tagline: "Every pumpkin in the patch was perfectly round and smooth — every pumpkin except one",
  ...
  // 8. Ollie's Cozy Corner
  {
    ...
    tagline: "Ollie was an indoor cat with a warm bed and zero reasons to go outside. One day, the door swung open.",
  ...
  // 11. Tom Turkey's Harvest Parade
  {
    ...
    tagline: "Sung to the tune of Wheels on the Bus — Thanksgiving is now permanently stuck in your head",
  ...
  // 12. Bailey's Frog Dream
  {
    ...
    tagline: "Bailey's family thought her frog dreams were a phase. Halloween was about to settle this once and for all.",
