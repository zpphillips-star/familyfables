...
const landDefs: LandDef[] = [
  // 1. Dragon Mountain
  {
    ...
    tagline: "She stepped through her closet. What was on the other side changed everything.",
  ...
  // 2. Poo Poo Face Town
  {
    ...
    tagline: "A boy and his dad set out to answer the most important question in history. Everyone has one.",
  ...
  // 3. Brian the Ghost's Haunted House
  {
    ...
    tagline: "Every monster in town had one job. Brian's approach was... different.",
  ...
  // 4. Hampton's Quest Meadow
  {
    ...
    tagline: "His best friend's birthday is tomorrow. Hampton has absolutely no idea what to get a rhino who has everything.",
  ...
  // 5. Gilroy's Harvest Forest
  {
    ...
    tagline: "Every turkey in the barnyard said 'gobble.' Gilroy opened his mouth. Nobody was ready.",
  ...
  // 6. Dream Land
  {
    ...
    emoji: "🌙",
    landName: "Dream Land",
    tagline: "What if your best idea ever only came to you when you were asleep?",
  ...
  // 7. Lumpiest Pumpkin Patch
  {
    ...
    tagline: "Every pumpkin in the patch was perfect. Then she spotted the one everyone else ignored.",
  ...
  // 8. Ollie's Cozy Corner
  {
    ...
    tagline: "Ollie had every reason to stay inside. Then the door swung open.",
  ...
  // 9. Shut-In Button Land
  {
    ...
    tagline: "Most buttons pop off by accident. This one had a plan.",
  ...
  // 10. Doodle-Do's Barnyard
  {
    ...
    tagline: "The rooster is awake. You're next. There is no off switch.",
  ...
  // 11. Tom Turkey's Harvest Parade
  {
    ...
    tagline: "Warning: this book is a Thanksgiving earworm. You have been informed.",
  ...
  // 12. Bailey's Frog Dream
  {
    ...
    tagline: "Bailey was a dog. She had other ideas. Halloween was about to prove everyone wrong.",
